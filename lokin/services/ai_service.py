...
Provides the foundation for all AI services in the Lokin framework, including
...
class AIService(FrameProcessor):
    ...
    async def _update_settings(self, settings: Mapping[str, Any]):
        from lokin.services.openai.realtime.events import SessionProperties
        ...
        for key, value in settings.items():
            ...
            if key in self._settings:
                ...
                try:
                    from lokin.services.openai.realtime.events import TurnDetection
