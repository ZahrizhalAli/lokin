"""Telnyx WebSocket frame serializer."""
...
class TelnyxFrameSerializer(FrameSerializer):
    ...
    This serializer handles converting between lokin. frames and Telnyx's WebSocket
    ...
    async def serialize(self, frame: Frame) -> str | bytes | None:
        """Serializes a lokin. frame to Telnyx WebSocket format.
    ...
    async def deserialize(self, data: str | bytes) -> Frame | None:
        """Deserializes Telnyx WebSocket data to lokin. frames.

        Handles conversion of Telnyx media events to appropriate lokin. frames,
        ...
        Returns:
            A lokin. frame corresponding to the Telnyx event, or None if unhandled.
