...
class VonageFrameSerializer(FrameSerializer):
    ...
    This serializer converts between lokin. frames and the Vonage Audio Connector
    ...
    async def serialize(self, frame: Frame) -> str | bytes | None:
        """Serializes a lokin. frame to Vonage WebSocket format.
    ...
    async def deserialize(self, data: str | bytes) -> Frame | None:
        """Deserializes Vonage WebSocket data to lokin. frames.

        Handles conversion of Vonage events to appropriate lokin. frames.
        ...
        Returns:
            A lokin. frame corresponding to the Vonage event, or None if unhandled.
        """
