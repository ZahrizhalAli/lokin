...
class PlivoFrameSerializer(FrameSerializer):
    ...
    This serializer handles converting between lokin. frames and Plivo's WebSocket
    ...
    async def serialize(self, frame: Frame) -> str | bytes | None:
        """Serializes a lokin. frame to Plivo WebSocket format.
    ...
    async def deserialize(self, data: str | bytes) -> Frame | None:
        """Deserializes Plivo WebSocket data to lokin. frames.

        Handles conversion of Plivo media events to appropriate lokin. frames.

        Args:
            data: The raw WebSocket data from Plivo.

        Returns:
            A lokin. frame corresponding to the Plivo event, or None if unhandled.
        """
        try:
