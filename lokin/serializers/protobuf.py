...
import lokin.frames.protobufs.frames_pb2 as frame_protos
...
class ProtobufFrameSerializer(FrameSerializer):
    """Serializer for converting Lokin frames to/from Protocol Buffer format.
