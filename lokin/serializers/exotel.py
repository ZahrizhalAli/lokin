"""Exotel Media Streams serializer."""
...
from lokin.audio.dtmf.types import KeypadEntry
from lokin.audio.utils import create_stream_resampler
...
class ExotelFrameSerializer(FrameSerializer):
    ...
    This serializer handles converting between lokin frames and Exotel's WebSocket
    ...
    async def serialize(self, frame: Frame) -> str | bytes | None:
        """Serializes a lokin frame to Exotel WebSocket format.
    ...
    async def deserialize(self, data: str | bytes) -> Frame | None:
        """Deserializes Exotel WebSocket data to lokin frames.

        Handles conversion of Exotel media events to appropriate lokin frames.

        Args:
            data: The raw WebSocket data from Exotel.

        Returns:
            A lokin frame corresponding to the Exotel event, or None if unhandled.
        """
