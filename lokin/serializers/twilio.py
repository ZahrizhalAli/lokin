...
from lokin.audio.utils import create_stream_resampler, pcm_to_ulaw, ulaw_to_pcm
...
class TwilioFrameSerializer(FrameSerializer):
    ...
    This serializer handles converting between lokin. frames and Twilio's WebSocket
    ...
    async def serialize(self, frame: Frame) -> str | bytes | None:
        """Serializes a lokin. frame to Twilio WebSocket format.
    ...
    async def deserialize(self, data: str | bytes) -> Frame | None:
        """Deserializes Twilio WebSocket data to lokin. frames.

        Handles conversion of Twilio media events to appropriate lokin. frames.

        Args:
            data: The raw WebSocket data from Twilio.

        Returns:
            A lokin. frame corresponding to the Twilio event, or None if unhandled.
        """
