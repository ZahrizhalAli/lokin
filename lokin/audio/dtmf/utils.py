...
from lokin.audio.resamplers.base_audio_resampler import BaseAudioResampler
from lokin.audio.utils import create_file_resampler
...
async def load_dtmf_audio(button: KeypadEntry, *, sample_rate: int = 8000) -> bytes:
    ...
    async with __DTMF_LOCK__:
        ...
        dtmf_file_path = files("lokin.audio.dtmf").joinpath(dtmf_file_name)
