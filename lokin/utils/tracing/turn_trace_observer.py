"""Turn trace observer for OpenTelemetry tracing.
...
from lokin.frames.frames import StartFrame
...
class TurnTraceObserver(BaseObserver):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._tracer = trace.get_tracer("lokin.turn") if is_tracing_available() else None
