...
warnings.warn(
    "lokin.utils.tracing.class_decorators is deprecated and will be removed in a future "
    "release. Use lokin.utils.tracing.service_decorators instead.",
    DeprecationWarning,
    stacklevel=2,
)
...
class Traceable:
    ...
    def __init__(self, name: str, **kwargs):
        ...
        self._tracer = trace.get_tracer("lokin")
        self._meter = metrics.get_meter("lokin")
