"""RTVI (Real-Time Voice Interface) protocol implementation.
...
from lokin.audio.utils import calculate_audio_volume
...
from lokin.services.llm_service import (
    FunctionCallParams,
)
...
from lokin.utils.string import match_endofsentence
...
class RTVIProcessor(FrameProcessor):
    ...
    async def _send_bot_ready(self, about: Mapping[str, Any] = None):
        ...
        if not about:
            about = {"library": "lokin", "library_version": f"1.0"}
